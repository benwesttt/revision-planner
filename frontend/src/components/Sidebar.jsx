...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 h-full z-50 w-64 bg-surface border-r border-border flex flex-col
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 pt-4 pb-2 md:hidden">
          <span className="text-sm font-semibold text-ink-secondary">Menu</span>
          <button
            onClick={onClose}
            className="flex items-center justify-center w-10 h-10 rounded-lg text-ink-muted hover:text-ink hover:bg-white/5 transition-colors"
